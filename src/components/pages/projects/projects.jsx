  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 my-40 responsive" id="projects" data-aos="fade-up">
      ...
      <div className="flex gap-5 responsive" data-aos="flip-down">
        ...
        <Project logo={LoginLogo} titulo="Login Screen" tecnologias={["React-js", "Style-C", "Firebase"]} link="https://github.com/OcttaDev/screen-login" github="https://github.com/OcttaDev/screen-login" />
